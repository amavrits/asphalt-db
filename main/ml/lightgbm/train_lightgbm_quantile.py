...
from src.ml.lightgbm import random_search_lgb, lgb_predict
...
if __name__ == "__main__":
    ...
    data_file = data_path / "from_bernadette/data_processed.csv"
    ...
    model_lower, params_lower = random_search_lgb(X_train, y_train, X_test, y_test, param_grid, alpha=0.05)
    ...
    predictions = lgb_predict(models, X_train, y_train, X_test, y_test)
