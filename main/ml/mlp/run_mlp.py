import pandas as pd
import numpy as np
from main.ml.mlp.mlp_utils import *
...
def run(n_splits, use_bitumen, epochs, lr, hidden_layers, log_y, probabilistic):
    ...
    if args.use_bitumen:
        ...
        if probabilistic:
            ...
            BASE_RESULT_PATH = SCRIPT_PATH.parent.parent.parent / "results/ml/mlp/w_bitumen"
    else:
        ...
        if probabilistic:
            ...
            BASE_RESULT_PATH = SCRIPT_PATH.parent.parent.parent / "results/ml/mlp/wo_bitumen"
...
def run_splits(data_path, base_result_path, n_splits, params, probabilistic, log_y=False):
